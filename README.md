...
100% correct for libfido2 1.16.0 – Tested december 2025  
...
| List resident keys / passkeys (recommended) | `fido2-token -L -r "$DEVICE"` (interactive) or `echo "PIN" \| fido2-token -L -r "$DEVICE"` | Shows RP ID, username, date – this is the good one |
